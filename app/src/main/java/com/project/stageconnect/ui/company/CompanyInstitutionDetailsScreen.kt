...
/**
 * Vue du détail de l'établissement de formation.
 *
 * @param institutionId L'identifiant de l'établissement de formation.
 * @param navController Le contrôleur de navigation.
 *
 * @return La vue du détail de l'établissement de formation.
 */
@Composable
fun CompanyInstitutionDetailsScreen(institutionId: String?, navController: NavController) {
